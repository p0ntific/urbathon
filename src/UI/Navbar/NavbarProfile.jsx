...
export default function NavbarProfile() {
  let name = useSelector((state) => state.profile.profile);
  name = name?.first_name + " " + name?.last_name;
  return (
    <div>
      <Menu>
        <MenuHandler>
          <div className="flex gap-6 items-center font-semibold text-black cursor-pointer">
            <svg
            ...
            {name?.first_name !== undefined ? name : "Ду юлия"}
          </div>
        </MenuHandler>
        <MenuList>
